  ...
  return (
    <nav className="fixed bottom-0 left-0 w-full z-50 flex justify-around items-center px-4 pb-8 pt-4 bg-[#fef9f3]/80 dark:bg-stone-950/80 backdrop-blur-xl shadow-[0_-4px_20px_rgba(145,77,0,0.08)] rounded-t-[2.5rem] border-t-0">
      <Link to="/dashboard" className={getNavClass('/dashboard')}>
        ...
        <span className="font-['Be_Vietnam_Pro'] text-[11px] font-semibold uppercase tracking-wider mt-1">{t("navHome", lang)}</span>
      </Link>
      <Link to="/history" className={getNavClass('/history')}>
        ...
        <span className="font-['Be_Vietnam_Pro'] text-[11px] font-semibold uppercase tracking-wider mt-0.5">{t("navHistory", lang)}</span>
      </Link>
      <Link to="/profile" className={getNavClass('/profile')}>
        ...
        <span className="font-['Be_Vietnam_Pro'] text-[11px] font-semibold uppercase tracking-wider mt-1">{t("navProfile", lang)}</span>
      </Link>
      <Link to="/settings" className={getNavClass('/settings')}>
        ...
        <span className="font-['Be_Vietnam_Pro'] text-[11px] font-semibold uppercase tracking-wider mt-1">{t("navSettings", lang)}</span>
      </Link>
    </nav>
  );
}
